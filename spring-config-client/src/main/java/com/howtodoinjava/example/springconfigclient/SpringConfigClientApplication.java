 ...
 * 
 * @SpringBootApplication public class SpringConfigClientApplication {
 * 
 * public static void main(String[] args) {
 * SpringApplication.run(SpringConfigClientApplication.class, args); }
 * 
 * @Autowired public void setEnv(Environment e) {
 ...
 * 
 * @Value("${msg:Config Server is not working. Please check...}") private String
 * msg;
 * 
 * @GetMapping("/msg") public String getMsg() { return this.msg; } }
 */