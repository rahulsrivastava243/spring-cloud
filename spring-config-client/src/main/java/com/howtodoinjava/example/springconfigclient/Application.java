 ...
 /**
	 ...
	 *
	 * also can be seen at: http://localhost:8080/env/info.foo
	 */
		  @Bean public CommandLineRunner printProperties(@Value("${msg}") final
		  String fooProperty) { return args -> LOGGER.info("info.foo is: [{}]",
		  fooProperty); }
